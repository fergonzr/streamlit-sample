...
Original file is located at
    https://colab.research.google.com/drive/1ebXyLdHRIBZudLDNEH6Z2DyrBTgYTmDm

# Despliegue de un modelo de regresión - Videojuegos
...
# Quotes for the options to match the dataframe columns
...
st.warning("El modelo tiene un error del 1% (mape: error porcentual)")